...
<head>
    <meta charset="utf-8">
    <title>Restablecer clave DAEMON</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#ffffff;border:1px solid #d8e0ec;">
                    <tr>
                        <td style="padding:28px 32px 12px;border-top:5px solid #0d6efd;">
                            ...
                            <h1 style="margin:0;font-size:28px;line-height:1.2;color:#091b33;">Restablece tu clave</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:18px 32px 4px;font-size:16px;line-height:1.6;">
                            <p>Hola {{ $usuario->nombre_completo ?: $usuario->usuario }},</p>
                            <p>Recibimos una solicitud para crear una nueva clave de acceso a tu cuenta DAEMON.</p>
                            ...
                            <p>Por seguridad, el enlace es de un solo uso y expira segun la configuracion de Firebase.</p>
