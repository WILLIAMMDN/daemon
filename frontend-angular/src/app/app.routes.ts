...
export const routes: Routes = [
  ...
  },
  {
    path: 'docente', loadComponent: () => import('./core/layouts/layout-docente/layout-docente').then((m) => m.LayoutDocente), canActivate: [authGuard, docenteGuard], children: [
      ...
      { path: 'cursos', loadComponent: () => import('./features/docente/pages/studio-cursos/studio-cursos').then((m) => m.StudioCursos), data: { titulo: 'Cursos', descripcion: 'Autoría, validación y publicación de versiones de curso.' } },
      { path: 'cursos/:courseId', loadComponent: () => import('./features/docente/pages/studio-curso/studio-curso').then((m) => m.StudioCurso) },
      { path: 'cursos/:courseId/version/:versionId', loadComponent: () => import('./features/docente/pages/studio-version/studio-version').then((m) => m.StudioVersion) },
      { path: 'sesiones', loadComponent: () => import('./features/docente/pages/sesiones-cohorte/sesiones-cohorte').then((m) => m.SesionesCohorteDocente), data: { titulo: 'Sesiones en vivo', descripcion: 'Programa y ajusta las clases sincronizadas de tus cohortes.', endpoint: '/academico/cohortes' } },
      { path: 'revisiones', loadComponent: () => import('./features/docente/pages/revisiones/revisiones').then((m) => m.RevisionesDocente), data: { titulo: 'Revisiones formativas', descripcion: 'Revisión de evidencias académicas y retroalimentación.' } },
