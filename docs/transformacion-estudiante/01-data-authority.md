...
| ADR                                                 | Decisión                                                                                                                                |
| --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| [ADR-001](../adr/ADR-001-autoridad-de-datos.md)     | Firebase Auth identifica; Laravel/PostgreSQL gobierna negocio; Firestore gobierna cuentos; Supabase Storage conserva binarios.          |
| [ADR-002](../adr/ADR-002-dominio-cuentos.md)        | Cuentos adopta Firestore como autoridad única mediante strangler sin eliminar endpoints ni hacer dual-write.                            |
| [ADR-003](../adr/ADR-003-autorizacion-firestore.md) | UID, reglas deny-by-default y servidor para transiciones privilegiadas; App Check solo defensa adicional.                               |
| [ADR-004](../adr/ADR-004-abstraccion-storage.md)    | `RepositorioActivosCuento` desacopla proveedor; Supabase se preserva, Firebase queda preparado y los writes se autorizan desde Laravel. |
| [ADR-005](../adr/ADR-005-experiencia-kids-teens.md) | Una sola app con perfil tipado KIDS/TEENS y publicación conservadora para menores.                                                      |
| [ADR-006](../adr/ADR-006-entornos.md)               | Local, test, staging y producción no comparten autoridades; cualquier mezcla falla cerrada.                                             |
